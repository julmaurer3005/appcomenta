...
| :--- | :--- | :--- | :--- |
| 📱 **App Android Nativo (.APK)** | Direto no Smartphone | Instalar o arquivo `.apk` | Roda 100% no celular Android, sem precisar do computador ligado. |
...
O projeto conta com uma versão nativa completa na pasta [`app_android/`](./app_android/):
